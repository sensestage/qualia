...
PolytopeAudioEnvironment::PolytopeAudioEnvironment( DataNetwork * d, const char *myName, int auid, int rewid, int outid) : currentObservation(1) {
...
//     dn->subscribeNode( settingsid, true );
    ...
    // create a node:
    dn->createNode( outputid, myName, 3, 0, true );
